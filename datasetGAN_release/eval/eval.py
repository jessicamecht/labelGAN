...
def load_images(path):
    ...
    """
    image_paths = []
    image_extensions = ["png", "jpg", "jpeg", "py"]
    for ext in image_extensions:
        for impath in os.listdir(path):
            if 'mask' in impath or 'pickle' in impath: continue
            image_paths.append(path + impath)
    image_paths = image_paths[0:1000]
    first_image = cv2.imread(image_paths[0])
    first_image = cv2.resize(first_image, (224, 224)) 
...
if __name__ == "__main__":
    ...
    images1 = load_images('../../../../../teams/group-9/datasetGAN_2000_generations_masks/')
    images2 = load_images('../../../../../teams/group-9/nih_data/train/')
